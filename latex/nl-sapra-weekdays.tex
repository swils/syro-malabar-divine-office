...
% Forced page break, to ensure that the refrain of Laku Mara is on the same
% page as the rest, to make it easier to repeat.
\ifthenelse{\boolean{isA5}}{\clearpage}{}
...
\begin{halfparskip}
  \liturgicaloption{II. Indien gezongen:}
\end{halfparskip}
...
\begin{halfparskip}
  ...
  % 22/06/2024: "Vanaf het begin en...  allemaal (verander trouwens de "allemaal" in "allen", dat klinkt beter)"
...
\begin{halfparskip}
  \liturgicaloption{Voor recitatie:}
\end{halfparskip}
