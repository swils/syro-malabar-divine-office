...
\begin{halfparskip}
  ...
  \liturgicalhint{(De voorhand van het heiligdom wordt nu geopend.)}
\end{halfparskip}

\fullline
\begin{halfparskip}
  \liturgicalhint{[Op grote feesten en gedachtensissen: Suyake: Pss 93-95 en 96-98. Volgende gebeden komen van de Hudra:]}
...
\markedsection{Onita D-Basaliqe}
...
\markedsection{Zumara (d’Marya Qretak)\footnote{De ``zumara'' hier is niet die van de qurbana, maar de \emph{d'Marya Qretak}, de eerst eigen tekst in Hudra \& Breviarium.}. Evangelion \markedsectionhint{(eigen, zie Hudra of Gaza)}}
...
\markedsection{Derde Suraya \markedsectionhint{(eigen)\footnote{Op feesten, wanneer er suyaka is, gaat de suraya vooraf aan de Onita d'Basaliqe, behalve op recentelijk toegevoegde feesten.}, gevolgd door 3x alleluia en het eerste vers herhaald.}}
