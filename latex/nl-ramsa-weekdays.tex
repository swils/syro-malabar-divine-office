...
\begin{halfparskip}
  \cc~Eer aan God in den hoge \liturgicalhint{(3x)}.
  ...
  \rr~Zegen, Heer.~--- \liturgicalhint{Vredekus.}
...
\begin{halfparskip}
  ...
  \psalm{\Ps{140}} Ik roep tot U, Heer; snel mij te hulp.

  \qanona{Luister naar mijn smeken, wanneer ik tot U roep.}
...
\begin{halfparskip}
  ...
  \cc~\liturgicalhint{(zegent de diaken.)} Moge Christus uw dienst heerlijk maken in het koninkrijk der hemelen \liturgicalhint{(De voorhang van het heiligdom wordt nu geopend.)}
...
\markedsection{Onze Vader \markedsectionhint{met antifoon.}}

\begin{halfparskip}
  \liturgicalhint{(Niet in de Vasten en Rogatie der Ninevieten, maar begin dan de Suba'a.)}
...
\fullline
\markedsection{Suba'a}

\liturgicalhint{(Op gedachtenissen, in de Vasten, Rogatie der Nineviten, niet op Zondagen en feesten van de Heer.)}
